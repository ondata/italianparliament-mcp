...
* [Freschezza del dato e cosa fa fede sull'approvazione](freschezza-e-autorevolezza.md) - due segnali da non confondere: `dcterms:modified` sui dataset è congelato al feb 2024, ma `ods:modified` per-record è vivo e rende la freschezza misurabile **per area** (atti al 28/07/2026, votazioni al 24/07, lavori d'Aula al 18/06). Il Senato non ne ha. Per l'esito (approvato/respinto/promulgato) la fonte di verità resta resoconto/scheda iter/GU. Distinzione "approvato da un ramo" ≠ "legge".
