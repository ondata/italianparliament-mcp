...
| `senato-attendance show` | Conteggio aggregato dei voti di un senatore in tutte le votazioni d'Assemblea di una legislatura (favorevole/contrario/astenuto/presente non votante/in congedo o missione) — misura di attivismo/assenteismo. `--legislature` è facoltativa: se omessa viene dedotta dalle legislature in cui quel senatore ha votato, quindi funziona anche per chi non è più in carica |
