...
export const CAPABILITIES: Capability[] = [
  ...
  { cmd: "committees list", terms: ["commissioni", "elenco commissioni", "giunta", "giunta per le autorizzazioni", "autorizzazione a procedere", "immunità parlamentare", "insindacabilità"], desc: "Commissioni e giunte Camera+Senato", example: "italianparliament committees list --chamber both --legislature 19" },
