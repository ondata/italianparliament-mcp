...
export const CAPABILITIES: Capability[] = [
  ...
  // "interrogazione senato per argomento" sta qui e non su `sindacato-ispettivo`:
  // il repertorio Senato non espone l'oggetto degli atti, mentre il dataset AIC
  // della Camera pubblica anche quelli del Senato col testo integrale.
  { cmd: "aic list", terms: ["interrogazione", "interpellanza", "mozione", "sindacato ispettivo camera", "tema", "interrogazione senato per argomento", "interrogazione senatore tema"], desc: "Atti di indirizzo e controllo, Camera e Senato (--keyword, --chamber)", example: "italianparliament aic list --legislature 19 --chamber senato --keyword nucleare" },
  { cmd: "sindacato-ispettivo list", terms: ["interrogazione senato", "interpellanza senato"], desc: "Sindacato ispettivo Senato (per argomento usa invece: aic list --chamber senato)", example: "italianparliament sindacato-ispettivo list --legislature 19 --keyword xylella" },
