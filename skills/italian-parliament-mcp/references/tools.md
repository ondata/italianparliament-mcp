...
- `withProponents`: aggiunge primo firmatario e cofirmatari dal testo AKN (il proponente NON è nel LOD; un fetch per emendamento, più lento: usarlo con `limit` contenuto)
